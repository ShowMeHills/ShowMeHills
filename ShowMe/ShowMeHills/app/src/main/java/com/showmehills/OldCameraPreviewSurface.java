...
public class OldCameraPreviewSurface extends SurfaceView {
    Camera camera;
    ...
    public OldCameraPreviewSurface(Context ctx)
    {
        super(ctx);
    }

    public OldCameraPreviewSurface(Context ctx, ShowMeHillsActivity myapp)
    {
        super(ctx);
        smh = myapp;
